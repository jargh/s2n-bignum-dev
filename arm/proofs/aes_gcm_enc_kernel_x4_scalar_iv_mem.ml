...
[
  ...
  0x3dc00cca;       (* arm_LDR Q10 X6 (Immediate_Offset (word 48)) *)
  0x110005b6;       (* arm_ADD W22 W13 (rvalue (word 1)) *)
  0x5ac009b9;       (* arm_REV W25 W13 *)
  0x3cc4041e;       (* arm_LDR Q30 X0 (Postimmediate_Offset (word 64)) *)
  0x5ac00ace;       (* arm_REV W14 W22 *)
  0xaa19818d;       (* arm_ORR X13 X12 (Shiftedreg X25 LSL 32) *)
  0x110006dc;       (* arm_ADD W28 W22 (rvalue (word 1)) *)
  0x3dc000d1;       (* arm_LDR Q17 X6 (Immediate_Offset (word 0)) *)
  0xaa0e8187;       (* arm_ORR X7 X12 (Shiftedreg X14 LSL 32) *)
  0xa90a37eb;       (* arm_STP X11 X13 SP (Immediate_Offset (iword (&160))) *)
  0x1100079e;       (* arm_ADD W30 W28 (rvalue (word 1)) *)
  0x110007cd;       (* arm_ADD W13 W30 (rvalue (word 1)) *)
  0xa90b1feb;       (* arm_STP X11 X7 SP (Immediate_Offset (iword (&176))) *)
  0x5ac00bd5;       (* arm_REV W21 W30 *)
  0x3dc02bff;       (* arm_LDR Q31 SP (Immediate_Offset (word 160)) *)
  0xaa158191;       (* arm_ORR X17 X12 (Shiftedreg X21 LSL 32) *)
  0x5ac00b8a;       (* arm_REV W10 W28 *)
  0x6e3c1fd0;       (* arm_EOR_VEC Q16 Q30 Q28 128 *)
  0x3dc02fe5;       (* arm_LDR Q5 SP (Immediate_Offset (word 176)) *)
  0xa90d47eb;       (* arm_STP X11 X17 SP (Immediate_Offset (iword (&208))) *)
  0xaa0a819a;       (* arm_ORR X26 X12 (Shiftedreg X10 LSL 32) *)
  0xa90c6beb;       (* arm_STP X11 X26 SP (Immediate_Offset (iword (&192))) *)
  0x3dc037fe;       (* arm_LDR Q30 SP (Immediate_Offset (word 208)) *)
  ...
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x3cdf000e;       (* arm_LDR Q14 X0 (Immediate_Offset (word 18446744073709551600)) *)
  0x4e284a65;       (* arm_AESE Q5 Q19 *)
  0x4e2868a5;       (* arm_AESMC Q5 Q5 *)
  0x3cde0000;       (* arm_LDR Q0 X0 (Immediate_Offset (word 18446744073709551584)) *)
  0x3cdd0003;       (* arm_LDR Q3 X0 (Immediate_Offset (word 18446744073709551568)) *)
  ...
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x6e3c1dc1;       (* arm_EOR_VEC Q1 Q14 Q28 128 *)
  0x6e3c1c06;       (* arm_EOR_VEC Q6 Q0 Q28 128 *)
  0x4e284aa5;       (* arm_AESE Q5 Q21 *)
  0x4e2868a5;       (* arm_AESMC Q5 Q5 *)
  0x4e284adf;       (* arm_AESE Q31 Q22 *)
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x6e3c1c63;       (* arm_EOR_VEC Q3 Q3 Q28 128 *)
  0x4e284ac5;       (* arm_AESE Q5 Q22 *)
  0x4e2868a5;       (* arm_AESMC Q5 Q5 *)
  0x3dc008dd;       (* arm_LDR Q29 X6 (Immediate_Offset (word 32)) *)
  ...
  0x4e286884;       (* arm_AESMC Q4 Q4 *)
  0x6e251c65;       (* arm_EOR_VEC Q5 Q3 Q5 128 *)
  ...
  0x4e286884;       (* arm_AESMC Q4 Q4 *)
  0x0eeae00c;       (* arm_PMULL_VEC Q12 Q0 Q10 64 *)
  0x5e180408;       (* arm_DUP_ELEM Q8 Q0 1 64 *)
  0x4e284ac4;       (* arm_AESE Q4 Q22 *)
  0x4e286884;       (* arm_AESMC Q4 Q4 *)
  0x6e3f1e09;       (* arm_EOR_VEC Q9 Q16 Q31 128 *)
  0x2e201d08;       (* arm_EOR_VEC Q8 Q8 Q0 64 *)
  0x4e284a7e;       (* arm_AESE Q30 Q19 *)
  0x4e286bde;       (* arm_AESMC Q30 Q30 *)
  0x4e20092e;       (* arm_REV64_VEC Q14 Q9 8 *)
  ...
  0x4e286884;       (* arm_AESMC Q4 Q4 *)
  0x6e2b1dcb;       (* arm_EOR_VEC Q11 Q14 Q11 128 *)
  ...
  0x4e286bde;       (* arm_AESMC Q30 Q30 *)
  0x4eefe16e;       (* arm_PMULL2_VEC Q14 Q11 Q15 64 *)
  0x6e241cc3;       (* arm_EOR_VEC Q3 Q6 Q4 128 *)
  0x4e284b3e;       (* arm_AESE Q30 Q25 *)
  0x4e286bde;       (* arm_AESMC Q30 Q30 *)
  0x0eefe17f;       (* arm_PMULL_VEC Q31 Q11 Q15 64 *)
  0x4e200870;       (* arm_REV64_VEC Q16 Q3 8 *)
  0x3c9e0043;       (* arm_STR Q3 X2 (Immediate_Offset (word 18446744073709551584)) *)
  0x4e284b5e;       (* arm_AESE Q30 Q26 *)
  0x4e286bde;       (* arm_AESMC Q30 Q30 *)
  0x0efde206;       (* arm_PMULL_VEC Q6 Q16 Q29 64 *)
  0x6e2c1fed;       (* arm_EOR_VEC Q13 Q31 Q12 128 *)
  0x4e284b7e;       (* arm_AESE Q30 Q27 *)
  0x6e104204;       (* arm_EXT Q4 Q16 Q16 64 *)
  0x4eeae00f;       (* arm_PMULL2_VEC Q15 Q0 Q10 64 *)
  0x6e261da6;       (* arm_EOR_VEC Q6 Q13 Q6 128 *)
  0x4efde203;       (* arm_PMULL2_VEC Q3 Q16 Q29 64 *)
  0x6e3e1c3d;       (* arm_EOR_VEC Q29 Q1 Q30 128 *)
  0x6e2f1dcb;       (* arm_EOR_VEC Q11 Q14 Q15 128 *)
  0x4ee2e12e;       (* arm_PMULL2_VEC Q14 Q9 Q2 64 *)
  0x6e301c84;       (* arm_EOR_VEC Q4 Q4 Q16 128 *)
  0x4e200ba0;       (* arm_REV64_VEC Q0 Q29 8 *)
  0x6e231d7f;       (* arm_EOR_VEC Q31 Q11 Q3 128 *)
  0x0ee2e108;       (* arm_PMULL_VEC Q8 Q8 Q2 64 *)
  0x0ef1e00f;       (* arm_PMULL_VEC Q15 Q0 Q17 64 *)
  0x5e180401;       (* arm_DUP_ELEM Q1 Q0 1 64 *)
  0x4ef1e01e;       (* arm_PMULL2_VEC Q30 Q0 Q17 64 *)
  0x6e281dc8;       (* arm_EOR_VEC Q8 Q14 Q8 128 *)
  0x2e201c29;       (* arm_EOR_VEC Q9 Q1 Q0 64 *)
  0x4ee5e08a;       (* arm_PMULL2_VEC Q10 Q4 Q5 64 *)
  0x6e3e1ff1;       (* arm_EOR_VEC Q17 Q31 Q30 128 *)
  0x6e2f1cc4;       (* arm_EOR_VEC Q4 Q6 Q15 128 *)
  0x0ee5e120;       (* arm_PMULL_VEC Q0 Q9 Q5 64 *)
  0x6e2a1d0a;       (* arm_EOR_VEC Q10 Q8 Q10 128 *)
  0x0ee7e22e;       (* arm_PMULL_VEC Q14 Q17 Q7 64 *)
  0x6e114225;       (* arm_EXT Q5 Q17 Q17 64 *)
  0x6e311c9e;       (* arm_EOR_VEC Q30 Q4 Q17 128 *)
  0x6e201d4a;       (* arm_EOR_VEC Q10 Q10 Q0 128 *)
  0x6e2e1ca0;       (* arm_EOR_VEC Q0 Q5 Q14 128 *)
  0x3c9f005d;       (* arm_STR Q29 X2 (Immediate_Offset (word 18446744073709551600)) *)
  0x6e3e1d4a;       (* arm_EOR_VEC Q10 Q10 Q30 128 *)
  0x6e201d40;       (* arm_EOR_VEC Q0 Q10 Q0 128 *)
  0x0ee7e01f;       (* arm_PMULL_VEC Q31 Q0 Q7 64 *)
  0x6e004000;       (* arm_EXT Q0 Q0 Q0 64 *)
  0x6e3f1c8a;       (* arm_EOR_VEC Q10 Q4 Q31 128 *)
  0x6e201d5f;       (* arm_EOR_VEC Q31 Q10 Q0 128 *)
  0x6e1f43eb;       (* arm_EXT Q11 Q31 Q31 64 *)
  ...
  0x6e3c1faa;       (* arm_EOR_VEC Q10 Q29 Q28 128 *)
  ...
  0x6e3d1d50;       (* arm_EOR_VEC Q16 Q10 Q29 128 *)
  0x3c810450;       (* arm_STR Q16 X2 (Postimmediate_Offset (word 16)) *)
  0x4e200a05;       (* arm_REV64_VEC Q5 Q16 8 *)
  0x6e2b1caf;       (* arm_EOR_VEC Q15 Q5 Q11 128 *)
  0x4eece1e6;       (* arm_PMULL2_VEC Q6 Q15 Q12 64 *)
  0x5e1805e0;       (* arm_DUP_ELEM Q0 Q15 1 64 *)
  0x0eece1e3;       (* arm_PMULL_VEC Q3 Q15 Q12 64 *)
  0x2e2f1c0d;       (* arm_EOR_VEC Q13 Q0 Q15 64 *)
  0x0ee7e0d1;       (* arm_PMULL_VEC Q17 Q6 Q7 64 *)
  0x6e261c64;       (* arm_EOR_VEC Q4 Q3 Q6 128 *)
  0x6e0640c6;       (* arm_EXT Q6 Q6 Q6 64 *)
  0x0eeee1a8;       (* arm_PMULL_VEC Q8 Q13 Q14 64 *)
  0x6e311cc9;       (* arm_EOR_VEC Q9 Q6 Q17 128 *)
  0x6e241d02;       (* arm_EOR_VEC Q2 Q8 Q4 128 *)
  0x6e291c41;       (* arm_EOR_VEC Q1 Q2 Q9 128 *)
  0x0ee7e03e;       (* arm_PMULL_VEC Q30 Q1 Q7 64 *)
  0x6e014026;       (* arm_EXT Q6 Q1 Q1 64 *)
  0x6e3e1c71;       (* arm_EOR_VEC Q17 Q3 Q30 128 *)
  0x6e261e26;       (* arm_EOR_VEC Q6 Q17 Q6 128 *)
    ...
    ASM_REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN REPEAT CONJ_TAC THENL
     [ARM_SIM_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_MEM_EXEC [1] THEN
      ...
      MAP_EVERY(fun n -> ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_MEM_EXEC [n] THEN
            RULE_ASSUM_TAC(CONV_RULE(TOP_DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)))
          (11--13) THEN
      MERGE_CTR128_TAC 176 "s13" THEN
      MAP_EVERY(fun n -> ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_MEM_EXEC [n] THEN
            RULE_ASSUM_TAC(CONV_RULE(TOP_DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)))
          (14--20) THEN
      MERGE_CTR128_TAC 208 "s20" THEN
      MAP_EVERY(fun n -> ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_MEM_EXEC [n] THEN
            RULE_ASSUM_TAC(CONV_RULE(TOP_DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)))
          (21--22) THEN
