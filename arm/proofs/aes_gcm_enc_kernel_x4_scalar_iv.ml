...
(* print_literal_from_elf "arm/aes_gcm/aes_gcm_enc_kernel_x4_scalar_iv.o";; *)

let aes_gcm_enc_kernel_x4_scalar_iv_mc =
  define_assert_from_elf "aes_gcm_enc_kernel_x4_scalar_iv_mc"
                         "arm/aes_gcm/aes_gcm_enc_kernel_x4_scalar_iv.o"
[
  ...
  0x9e670162;       (* arm_FMOV_ItoF Q2 X11 0 *)
  0x3cc4040d;       (* arm_LDR Q13 X0 (Postimmediate_Offset (word 64)) *)
  0x5ac009b8;       (* arm_REV W24 W13 *)
  0x110005b5;       (* arm_ADD W21 W13 (rvalue (word 1)) *)
  0x9e67017f;       (* arm_FMOV_ItoF Q31 X11 0 *)
  0x3cdf000a;       (* arm_LDR Q10 X0 (Immediate_Offset (word 18446744073709551600)) *)
  0x5ac00abd;       (* arm_REV W29 W21 *)
  0x110006ad;       (* arm_ADD W13 W21 (rvalue (word 1)) *)
  0x3dc00cc3;       (* arm_LDR Q3 X6 (Immediate_Offset (word 48)) *)
  0xaa1d8188;       (* arm_ORR X8 X12 (Shiftedreg X29 LSL 32) *)
  0xaa18819d;       (* arm_ORR X29 X12 (Shiftedreg X24 LSL 32) *)
  0x5ac009b4;       (* arm_REV W20 W13 *)
  0x9eaf03a2;       (* arm_FMOV_ItoF Q2 X29 1 *)
  0x3cdd0000;       (* arm_LDR Q0 X0 (Immediate_Offset (word 18446744073709551568)) *)
  0xaa14818a;       (* arm_ORR X10 X12 (Shiftedreg X20 LSL 32) *)
  0x110005be;       (* arm_ADD W30 W13 (rvalue (word 1)) *)
  0x9eaf015f;       (* arm_FMOV_ItoF Q31 X10 1 *)
  0x3cde000f;       (* arm_LDR Q15 X0 (Immediate_Offset (word 18446744073709551584)) *)
  0x6e3c1da8;       (* arm_EOR_VEC Q8 Q13 Q28 128 *)
  0x6e3c1d49;       (* arm_EOR_VEC Q9 Q10 Q28 128 *)
  0x4e284a42;       (* arm_AESE Q2 Q18 *)
  0x4e286842;       (* arm_AESMC Q2 Q2 *)
  0x9e670171;       (* arm_FMOV_ItoF Q17 X11 0 *)
  0x4e284a5f;       (* arm_AESE Q31 Q18 *)
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x5ac00bcd;       (* arm_REV W13 W30 *)
  0x9e67016d;       (* arm_FMOV_ItoF Q13 X11 0 *)
  0x4e284a62;       (* arm_AESE Q2 Q19 *)
  0x4e286842;       (* arm_AESMC Q2 Q2 *)
  0x4e284a7f;       (* arm_AESE Q31 Q19 *)
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x6e3c1def;       (* arm_EOR_VEC Q15 Q15 Q28 128 *)
  0xaa0d8196;       (* arm_ORR X22 X12 (Shiftedreg X13 LSL 32) *)
  0x4e284a82;       (* arm_AESE Q2 Q20 *)
  0x4e286842;       (* arm_AESMC Q2 Q2 *)
  0x110007cd;       (* arm_ADD W13 W30 (rvalue (word 1)) *)
  0x4e284a9f;       (* arm_AESE Q31 Q20 *)
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x9eaf02cd;       (* arm_FMOV_ItoF Q13 X22 1 *)
  0x4e284aa2;       (* arm_AESE Q2 Q21 *)
  0x4e286842;       (* arm_AESMC Q2 Q2 *)
  0x3dc004ca;       (* arm_LDR Q10 X6 (Immediate_Offset (word 16)) *)
  0x4e284abf;       (* arm_AESE Q31 Q21 *)
  0x4e286bff;       (* arm_AESMC Q31 Q31 *)
  0x9eaf0111;       (* arm_FMOV_ItoF Q17 X8 1 *)
  ...
  0x6e221d0e;       (* arm_EOR_VEC Q14 Q8 Q2 128 *)
  ...
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x6e3c1c10;       (* arm_EOR_VEC Q16 Q0 Q28 128 *)
  0x6e2b1d82;       (* arm_EOR_VEC Q2 Q12 Q11 128 *)
  0x4e284a91;       (* arm_AESE Q17 Q20 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x3c84044e;       (* arm_STR Q14 X2 (Postimmediate_Offset (word 64)) *)
  0x4e284b7f;       (* arm_AESE Q31 Q27 *)
  0x6e024046;       (* arm_EXT Q6 Q2 Q2 64 *)
  0x4e284ab1;       (* arm_AESE Q17 Q21 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x6e3f1deb;       (* arm_EOR_VEC Q11 Q15 Q31 128 *)
  0x4e284aad;       (* arm_AESE Q13 Q21 *)
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x6e221cc4;       (* arm_EOR_VEC Q4 Q6 Q2 128 *)
  0x4e284ad1;       (* arm_AESE Q17 Q22 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x4e284acd;       (* arm_AESE Q13 Q22 *)
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x3c9e004b;       (* arm_STR Q11 X2 (Immediate_Offset (word 18446744073709551584)) *)
  0x4e284af1;       (* arm_AESE Q17 Q23 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x3dc000cc;       (* arm_LDR Q12 X6 (Immediate_Offset (word 0)) *)
  0x4e284aed;       (* arm_AESE Q13 Q23 *)
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x4e200966;       (* arm_REV64_VEC Q6 Q11 8 *)
  0x3dc010c5;       (* arm_LDR Q5 X6 (Immediate_Offset (word 64)) *)
  0x4e284b11;       (* arm_AESE Q17 Q24 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x4e284b0d;       (* arm_AESE Q13 Q24 *)
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x6e0640cf;       (* arm_EXT Q15 Q6 Q6 64 *)
  0x3dc008c1;       (* arm_LDR Q1 X6 (Immediate_Offset (word 32)) *)
  0x4e284b31;       (* arm_AESE Q17 Q25 *)
  0x4e286a31;       (* arm_AESMC Q17 Q17 *)
  0x4e284b2d;       (* arm_AESE Q13 Q25 *)
  0x4e2869ad;       (* arm_AESMC Q13 Q13 *)
  0x6e261def;       (* arm_EOR_VEC Q15 Q15 Q6 128 *)
  ...
  0x6e311e11;       (* arm_EOR_VEC Q17 Q16 Q17 128 *)
  0x4eeae1fd;       (* arm_PMULL2_VEC Q29 Q15 Q10 64 *)
  0x6e2d1d29;       (* arm_EOR_VEC Q9 Q9 Q13 128 *)
  0x4ee8e04e;       (* arm_PMULL2_VEC Q14 Q2 Q8 64 *)
  0x4e200a20;       (* arm_REV64_VEC Q0 Q17 8 *)
  0x0ee1e0cb;       (* arm_PMULL_VEC Q11 Q6 Q1 64 *)
  0x0ee8e048;       (* arm_PMULL_VEC Q8 Q2 Q8 64 *)
  0x4e20093f;       (* arm_REV64_VEC Q31 Q9 8 *)
  0x0ee3e002;       (* arm_PMULL_VEC Q2 Q0 Q3 64 *)
  0x5e18040f;       (* arm_DUP_ELEM Q15 Q0 1 64 *)
  0x4ee5e090;       (* arm_PMULL2_VEC Q16 Q4 Q5 64 *)
  0x5e1807fe;       (* arm_DUP_ELEM Q30 Q31 1 64 *)
  0x2e201ded;       (* arm_EOR_VEC Q13 Q15 Q0 64 *)
  0x4ee3e004;       (* arm_PMULL2_VEC Q4 Q0 Q3 64 *)
  0x2e3f1fc3;       (* arm_EOR_VEC Q3 Q30 Q31 64 *)
  0x0eece3fe;       (* arm_PMULL_VEC Q30 Q31 Q12 64 *)
  0x4ee1e0c6;       (* arm_PMULL2_VEC Q6 Q6 Q1 64 *)
  0x6e241dc1;       (* arm_EOR_VEC Q1 Q14 Q4 128 *)
  0x6e221d08;       (* arm_EOR_VEC Q8 Q8 Q2 128 *)
  0x0ee5e1a4;       (* arm_PMULL_VEC Q4 Q13 Q5 64 *)
  0x4eece3e2;       (* arm_PMULL2_VEC Q2 Q31 Q12 64 *)
  0x6e261c3f;       (* arm_EOR_VEC Q31 Q1 Q6 128 *)
  0x6e241e04;       (* arm_EOR_VEC Q4 Q16 Q4 128 *)
  0x6e2b1d01;       (* arm_EOR_VEC Q1 Q8 Q11 128 *)
  0x6e221fe2;       (* arm_EOR_VEC Q2 Q31 Q2 128 *)
  0x0eeae06a;       (* arm_PMULL_VEC Q10 Q3 Q10 64 *)
  0x6e3d1c9d;       (* arm_EOR_VEC Q29 Q4 Q29 128 *)
  0x6e3e1c30;       (* arm_EOR_VEC Q16 Q1 Q30 128 *)
  0x0ee7e045;       (* arm_PMULL_VEC Q5 Q2 Q7 64 *)
  0x6e02404f;       (* arm_EXT Q15 Q2 Q2 64 *)
  0x6e2a1fbe;       (* arm_EOR_VEC Q30 Q29 Q10 128 *)
  0x6e221e0a;       (* arm_EOR_VEC Q10 Q16 Q2 128 *)
  0x3c9d0051;       (* arm_STR Q17 X2 (Immediate_Offset (word 18446744073709551568)) *)
  0x6e251def;       (* arm_EOR_VEC Q15 Q15 Q5 128 *)
  0x3c9f0049;       (* arm_STR Q9 X2 (Immediate_Offset (word 18446744073709551600)) *)
  0x6e2a1fc5;       (* arm_EOR_VEC Q5 Q30 Q10 128 *)
  0x6e2f1caf;       (* arm_EOR_VEC Q15 Q5 Q15 128 *)
  0x6e0f41ea;       (* arm_EXT Q10 Q15 Q15 64 *)
  0x0ee7e1ef;       (* arm_PMULL_VEC Q15 Q15 Q7 64 *)
  0x6e2f1e0f;       (* arm_EOR_VEC Q15 Q16 Q15 128 *)
  0x6e2a1def;       (* arm_EOR_VEC Q15 Q15 Q10 128 *)
  ...
  0x3cc10402;       (* arm_LDR Q2 X0 (Postimmediate_Offset (word 16)) *)
  0x9e670166;       (* arm_FMOV_ItoF Q6 X11 0 *)
  0x5ac009be;       (* arm_REV W30 W13 *)
  0x110005ad;       (* arm_ADD W13 W13 (rvalue (word 1)) *)
  0xaa1e8194;       (* arm_ORR X20 X12 (Shiftedreg X30 LSL 32) *)
  0x9eaf0286;       (* arm_FMOV_ItoF Q6 X20 1 *)
  0x6e3c1c41;       (* arm_EOR_VEC Q1 Q2 Q28 128 *)
  0x4e284a46;       (* arm_AESE Q6 Q18 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284a66;       (* arm_AESE Q6 Q19 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284a86;       (* arm_AESE Q6 Q20 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284aa6;       (* arm_AESE Q6 Q21 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284ac6;       (* arm_AESE Q6 Q22 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284ae6;       (* arm_AESE Q6 Q23 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284b06;       (* arm_AESE Q6 Q24 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284b26;       (* arm_AESE Q6 Q25 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284b46;       (* arm_AESE Q6 Q26 *)
  0x4e2868c6;       (* arm_AESMC Q6 Q6 *)
  0x4e284b66;       (* arm_AESE Q6 Q27 *)
  0x6e261c2d;       (* arm_EOR_VEC Q13 Q1 Q6 128 *)
  0x3c81044d;       (* arm_STR Q13 X2 (Postimmediate_Offset (word 16)) *)
  0x4e2009a8;       (* arm_REV64_VEC Q8 Q13 8 *)
  0x6e2b1d1e;       (* arm_EOR_VEC Q30 Q8 Q11 128 *)
  0x0eece3d1;       (* arm_PMULL_VEC Q17 Q30 Q12 64 *)
  0x5e1807cb;       (* arm_DUP_ELEM Q11 Q30 1 64 *)
  0x4eece3c9;       (* arm_PMULL2_VEC Q9 Q30 Q12 64 *)
  0x2e3e1d6b;       (* arm_EOR_VEC Q11 Q11 Q30 64 *)
  0x0ee7e12f;       (* arm_PMULL_VEC Q15 Q9 Q7 64 *)
  0x6e094128;       (* arm_EXT Q8 Q9 Q9 64 *)
  0x0eeee164;       (* arm_PMULL_VEC Q4 Q11 Q14 64 *)
  0x6e291e2b;       (* arm_EOR_VEC Q11 Q17 Q9 128 *)
  0x6e2f1d03;       (* arm_EOR_VEC Q3 Q8 Q15 128 *)
  0x6e2b1c9f;       (* arm_EOR_VEC Q31 Q4 Q11 128 *)
  0x6e231feb;       (* arm_EOR_VEC Q11 Q31 Q3 128 *)
  0x6e0b4169;       (* arm_EXT Q9 Q11 Q11 64 *)
  0x0ee7e16b;       (* arm_PMULL_VEC Q11 Q11 Q7 64 *)
  0x6e2b1e2f;       (* arm_EOR_VEC Q15 Q17 Q11 128 *)
  0x6e291de9;       (* arm_EOR_VEC Q9 Q15 Q9 128 *)
  0x6e09412b;       (* arm_EXT Q11 Q9 Q9 64 *)
...
let AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC = ARM_MK_EXEC_RULE aes_gcm_enc_kernel_x4_scalar_iv_mc;;
...
let CTR_BLOCK_BUILD_INSERT = prove
 (`word_insert
     (word_zx (word_subword
        (word_reversefields 8 (ctr_block nonce 2):int128) (0,64):int64):int128)
     (64,64)
     (word_or
       (word_zx ((word_zx (word_subword
          (word_reversefields 8 (ctr_block nonce 2):int128) (64,64):int64)):int32):int64)
...
let AES_GCM_ENC_KERNEL_X4_SCALAR_IV_CORRECT = prove
 (`!in_p out_p len_bits tag_p ivec_p key_p htable_p tag0 nonce rk inblock pc.
       ALLPAIRS nonoverlapping
        ...
        [(word pc, LENGTH aes_gcm_enc_kernel_x4_scalar_iv_mc);
         (in_p,  16 * val len_bits DIV 128); (key_p, 176); (htable_p, 192)] /\
       PAIRWISE nonoverlapping
        [(out_p, 16 * val len_bits DIV 128); (tag_p, 16); (ivec_p, 16)]
    ==>
    ensures arm
      (\s. aligned_bytes_loaded s (word pc) aes_gcm_enc_kernel_x4_scalar_iv_mc /\
  ...
  REWRITE_TAC[ALLPAIRS; PAIRWISE; ALL; fst AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC] THEN
  ...
  REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN CONJ_TAC THENL
   [ENSURES_INIT_TAC "s0" THEN
    ...
    ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC (1--23) THEN
  ...
  REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN CONJ_TAC THENL
   [ASM_CASES_TAC `loop_count = 0` THENL
     [POP_ASSUM SUBST_ALL_TAC THEN
      ARM_SIM_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC [1] THEN
     ...
     [ARM_SIM_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC [1] THEN
      ...
      STRIP_ASSUME_TAC THENL
       [REWRITE_TAC[ARITH_RULE
        ...
        ALL_TAC] THEN
      MAP_EVERY(fun n -> ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC [n] THEN
...
let AES_GCM_ENC_KERNEL_X4_SCALAR_IV_SUBROUTINE_CORRECT = prove
 (`!in_p out_p len_bits tag_p ivec_p key_p htable_p tag0 nonce rk inblock
  ...
  REWRITE_TAC[fst AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC; htable_mem_4] THEN
  CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
  ARM_ADD_RETURN_STACK_TAC
    ~pre_post_nsteps:(11, 11)
    AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC
    (CONV_RULE(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV)
       (REWRITE_RULE[fst AES_GCM_ENC_KERNEL_X4_SCALAR_IV_EXEC; htable_mem_4]
          AES_GCM_ENC_KERNEL_X4_SCALAR_IV_CORRECT))
