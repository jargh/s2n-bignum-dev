...
let bignum_neg_p256_mc = define_assert_from_elf "bignum_neg_p256_mc" "arm/p256/bignum_neg_p256.o"
[
...
let BIGNUM_NEG_P256_EXEC = ARM_MK_EXEC_RULE bignum_neg_p256_mc;;
...
let full_spec,public_vars = mk_safety_spec
    ...
    BIGNUM_NEG_P256_SUBROUTINE_CORRECT
...
let BIGNUM_NEG_P256_SUBROUTINE_SAFE = time prove
 (`exists f_events.
     forall e z x pc returnaddress.
         ...
         ==> ensures arm
             (\s.
                  aligned_bytes_loaded s (word pc) bignum_neg_p256_mc /\
                  read PC s = word pc /\
                  read X30 s = returnaddress /\
                  C_ARGUMENTS [z; x] s /\
                  read events s = e)
