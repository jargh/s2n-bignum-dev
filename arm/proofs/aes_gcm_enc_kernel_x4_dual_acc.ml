...
(* print_literal_from_elf "arm/aes_gcm/aes_gcm_enc_kernel_x4_dual_acc.o";; *)

let aes_gcm_enc_kernel_x4_dual_acc_mc =
  define_assert_from_elf "aes_gcm_enc_kernel_x4_dual_acc_mc"
                         "arm/aes_gcm/aes_gcm_enc_kernel_x4_dual_acc.o"
[
  ...
  0xb4001301;       (* arm_CBZ X1 (word 608) *)
  0x3dc004dd;       (* arm_LDR Q29 X6 (Immediate_Offset (word 16)) *)
  0x4ebe87f0;       (* arm_ADD_VEC Q16 Q31 Q30 32 128 *)
  0x3dc00411;       (* arm_LDR Q17 X0 (Immediate_Offset (word 16)) *)
  0x6e200bec;       (* arm_REV32_VEC Q12 Q31 8 *)
  0x4ebe8608;       (* arm_ADD_VEC Q8 Q16 Q30 32 128 *)
  0x6e200a0f;       (* arm_REV32_VEC Q15 Q16 8 *)
  0x3cc4041f;       (* arm_LDR Q31 X0 (Postimmediate_Offset (word 64)) *)
  0x4e284a4c;       (* arm_AESE Q12 Q18 *)
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x4ebe8500;       (* arm_ADD_VEC Q0 Q8 Q30 32 128 *)
  0x4e284a4f;       (* arm_AESE Q15 Q18 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x6e200910;       (* arm_REV32_VEC Q16 Q8 8 *)
  0x4e284a6c;       (* arm_AESE Q12 Q19 *)
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x4e284a6f;       (* arm_AESE Q15 Q19 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x6e200808;       (* arm_REV32_VEC Q8 Q0 8 *)
  0x4e284a50;       (* arm_AESE Q16 Q18 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x3dc010c1;       (* arm_LDR Q1 X6 (Immediate_Offset (word 64)) *)
  0x4e284a8f;       (* arm_AESE Q15 Q20 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x6e3c1fff;       (* arm_EOR_VEC Q31 Q31 Q28 128 *)
  0x4e284a70;       (* arm_AESE Q16 Q19 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x3dc014c4;       (* arm_LDR Q4 X6 (Immediate_Offset (word 80)) *)
  0x4e284aaf;       (* arm_AESE Q15 Q21 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x6e3c1e31;       (* arm_EOR_VEC Q17 Q17 Q28 128 *)
  0x3dc00cce;       (* arm_LDR Q14 X6 (Immediate_Offset (word 48)) *)
  0x4e284a90;       (* arm_AESE Q16 Q20 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x4e284acf;       (* arm_AESE Q15 Q22 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x3cde0002;       (* arm_LDR Q2 X0 (Immediate_Offset (word 18446744073709551584)) *)
  0x4e284ab0;       (* arm_AESE Q16 Q21 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x3cdf0003;       (* arm_LDR Q3 X0 (Immediate_Offset (word 18446744073709551600)) *)
  0x4e284aef;       (* arm_AESE Q15 Q23 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x4e284ad0;       (* arm_AESE Q16 Q22 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x6e3c1c42;       (* arm_EOR_VEC Q2 Q2 Q28 128 *)
  0x4e284a8c;       (* arm_AESE Q12 Q20 *)
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x4e284b0f;       (* arm_AESE Q15 Q24 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x4e284aac;       (* arm_AESE Q12 Q21 *)
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x4e284b2f;       (* arm_AESE Q15 Q25 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  0x4e284acc;       (* arm_AESE Q12 Q22 *)
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x4e284b4f;       (* arm_AESE Q15 Q26 *)
  0x4e2869ef;       (* arm_AESMC Q15 Q15 *)
  ...
  0x4e28698c;       (* arm_AESMC Q12 Q12 *)
  0x6e3c1c66;       (* arm_EOR_VEC Q6 Q3 Q28 128 *)
  0x4e284aa8;       (* arm_AESE Q8 Q21 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x4e284b6c;       (* arm_AESE Q12 Q27 *)
  0x4e284b6f;       (* arm_AESE Q15 Q27 *)
  0x3dc000c9;       (* arm_LDR Q9 X6 (Immediate_Offset (word 0)) *)
  0x6e2c1fff;       (* arm_EOR_VEC Q31 Q31 Q12 128 *)
  0x4e284ac8;       (* arm_AESE Q8 Q22 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x4e284af0;       (* arm_AESE Q16 Q23 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x6e2f1e2d;       (* arm_EOR_VEC Q13 Q17 Q15 128 *)
  0x4e200bef;       (* arm_REV64_VEC Q15 Q31 8 *)
  0x4e284ae8;       (* arm_AESE Q8 Q23 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x4e2009ac;       (* arm_REV64_VEC Q12 Q13 8 *)
  0x4e284b10;       (* arm_AESE Q16 Q24 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x4e284b08;       (* arm_AESE Q8 Q24 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x6e2b1de5;       (* arm_EOR_VEC Q5 Q15 Q11 128 *)
  0x3c84045f;       (* arm_STR Q31 X2 (Postimmediate_Offset (word 64)) *)
  0x4e284b30;       (* arm_AESE Q16 Q25 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x4ec5698a;       (* arm_TRN2 Q10 Q12 Q5 64 128 *)
  0x4e284b28;       (* arm_AESE Q8 Q25 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x4e284b50;       (* arm_AESE Q16 Q26 *)
  0x4e286a10;       (* arm_AESMC Q16 Q16 *)
  0x4ec5298b;       (* arm_TRN1 Q11 Q12 Q5 64 128 *)
  0x3c9d004d;       (* arm_STR Q13 X2 (Immediate_Offset (word 18446744073709551568)) *)
  0x4e284b48;       (* arm_AESE Q8 Q26 *)
  0x4e286908;       (* arm_AESMC Q8 Q8 *)
  0x4e284b70;       (* arm_AESE Q16 Q27 *)
  0x6e2a1d7f;       (* arm_EOR_VEC Q31 Q11 Q10 128 *)
  0x3dc008cd;       (* arm_LDR Q13 X6 (Immediate_Offset (word 32)) *)
  0x4e284b68;       (* arm_AESE Q8 Q27 *)
  0x4ee1e3ef;       (* arm_PMULL2_VEC Q15 Q31 Q1 64 *)
  0x6e301c4a;       (* arm_EOR_VEC Q10 Q2 Q16 128 *)
  0x0ee1e3e2;       (* arm_PMULL_VEC Q2 Q31 Q1 64 *)
  0x6e281cc3;       (* arm_EOR_VEC Q3 Q6 Q8 128 *)
  0x4eeee191;       (* arm_PMULL2_VEC Q17 Q12 Q14 64 *)
  0x4e200941;       (* arm_REV64_VEC Q1 Q10 8 *)
  0x0ee4e0ab;       (* arm_PMULL_VEC Q11 Q5 Q4 64 *)
  0x4e200868;       (* arm_REV64_VEC Q8 Q3 8 *)
  0x6e221de6;       (* arm_EOR_VEC Q6 Q15 Q2 128 *)
  0x0eeee18e;       (* arm_PMULL_VEC Q14 Q12 Q14 64 *)
  0x4ec1690c;       (* arm_TRN2 Q12 Q8 Q1 64 128 *)
  0x4eede022;       (* arm_PMULL2_VEC Q2 Q1 Q13 64 *)
  0x4ee4e0a4;       (* arm_PMULL2_VEC Q4 Q5 Q4 64 *)
  0x4ec1290f;       (* arm_TRN1 Q15 Q8 Q1 64 128 *)
  0x0eede030;       (* arm_PMULL_VEC Q16 Q1 Q13 64 *)
  0x4ebe841f;       (* arm_ADD_VEC Q31 Q0 Q30 32 128 *)
  0x6e311c85;       (* arm_EOR_VEC Q5 Q4 Q17 128 *)
  0x6e2e1d64;       (* arm_EOR_VEC Q4 Q11 Q14 128 *)
  0x0ee9e111;       (* arm_PMULL_VEC Q17 Q8 Q9 64 *)
  0x6e2c1def;       (* arm_EOR_VEC Q15 Q15 Q12 128 *)
  0x6e221cae;       (* arm_EOR_VEC Q14 Q5 Q2 128 *)
  0x4ee9e100;       (* arm_PMULL2_VEC Q0 Q8 Q9 64 *)
  0x6e301c8c;       (* arm_EOR_VEC Q12 Q4 Q16 128 *)
  0x4efde1e8;       (* arm_PMULL2_VEC Q8 Q15 Q29 64 *)
  0x6e201dc4;       (* arm_EOR_VEC Q4 Q14 Q0 128 *)
  0x0efde1e1;       (* arm_PMULL_VEC Q1 Q15 Q29 64 *)
  0x6e311d89;       (* arm_EOR_VEC Q9 Q12 Q17 128 *)
  0x6e281cd1;       (* arm_EOR_VEC Q17 Q6 Q8 128 *)
  0x6e04408e;       (* arm_EXT Q14 Q4 Q4 64 *)
  0x0ee7e080;       (* arm_PMULL_VEC Q0 Q4 Q7 64 *)
  0x6e241d22;       (* arm_EOR_VEC Q2 Q9 Q4 128 *)
  0x6e211e2d;       (* arm_EOR_VEC Q13 Q17 Q1 128 *)
  0x3c9f0043;       (* arm_STR Q3 X2 (Immediate_Offset (word 18446744073709551600)) *)
  0x3c9e004a;       (* arm_STR Q10 X2 (Immediate_Offset (word 18446744073709551584)) *)
  0x6e201dc6;       (* arm_EOR_VEC Q6 Q14 Q0 128 *)
  0x6e221daa;       (* arm_EOR_VEC Q10 Q13 Q2 128 *)
  0x6e261d4c;       (* arm_EOR_VEC Q12 Q10 Q6 128 *)
  0x0ee7e18a;       (* arm_PMULL_VEC Q10 Q12 Q7 64 *)
  0x6e0c4185;       (* arm_EXT Q5 Q12 Q12 64 *)
  0x6e2a1d2a;       (* arm_EOR_VEC Q10 Q9 Q10 128 *)
  0x6e251d45;       (* arm_EOR_VEC Q5 Q10 Q5 128 *)
  0x6e0540ab;       (* arm_EXT Q11 Q5 Q5 64 *)
  0xd1000421;       (* arm_SUB X1 X1 (rvalue (word 1)) *)
  0xb5ffed41;       (* arm_CBNZ X1 (word 2096552) *)
  ...
  0x6e200bf1;       (* arm_REV32_VEC Q17 Q31 8 *)
  ...
  0x6e3c1ca1;       (* arm_EOR_VEC Q1 Q5 Q28 128 *)
  ...
  0x6e311c24;       (* arm_EOR_VEC Q4 Q1 Q17 128 *)
  0x3c810444;       (* arm_STR Q4 X2 (Postimmediate_Offset (word 16)) *)
  0x4e200883;       (* arm_REV64_VEC Q3 Q4 8 *)
  0x6e2b1c6b;       (* arm_EOR_VEC Q11 Q3 Q11 128 *)
  0x0eece16f;       (* arm_PMULL_VEC Q15 Q11 Q12 64 *)
  0x5e180568;       (* arm_DUP_ELEM Q8 Q11 1 64 *)
  0x4eece162;       (* arm_PMULL2_VEC Q2 Q11 Q12 64 *)
  0x2e2b1d0a;       (* arm_EOR_VEC Q10 Q8 Q11 64 *)
  0x6e221df0;       (* arm_EOR_VEC Q16 Q15 Q2 128 *)
  0x0ee7e046;       (* arm_PMULL_VEC Q6 Q2 Q7 64 *)
  0x0eeee149;       (* arm_PMULL_VEC Q9 Q10 Q14 64 *)
  0x6e024042;       (* arm_EXT Q2 Q2 Q2 64 *)
  0x6e301d20;       (* arm_EOR_VEC Q0 Q9 Q16 128 *)
  0x6e261c46;       (* arm_EOR_VEC Q6 Q2 Q6 128 *)
  0x6e261c0d;       (* arm_EOR_VEC Q13 Q0 Q6 128 *)
  0x0ee7e1a2;       (* arm_PMULL_VEC Q2 Q13 Q7 64 *)
  0x6e221de5;       (* arm_EOR_VEC Q5 Q15 Q2 128 *)
  0x6e0d41a2;       (* arm_EXT Q2 Q13 Q13 64 *)
  0x6e221ca2;       (* arm_EOR_VEC Q2 Q5 Q2 128 *)
...
let AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC = ARM_MK_EXEC_RULE aes_gcm_enc_kernel_x4_dual_acc_mc;;
...
let AES_GCM_ENC_KERNEL_X4_DUAL_ACC_CORRECT = prove
 (`!in_p out_p len_bits tag_p ivec_p key_p htable_p tag0 nonce rk inblock pc.
       ALLPAIRS nonoverlapping
        ...
        [(word pc, LENGTH aes_gcm_enc_kernel_x4_dual_acc_mc);
         (in_p,  16 * val len_bits DIV 128); (key_p, 176); (htable_p, 192)] /\
       PAIRWISE nonoverlapping
        [(out_p, 16 * val len_bits DIV 128); (tag_p, 16); (ivec_p, 16)]
    ==>
    ensures arm
      (\s. aligned_bytes_loaded s (word pc) aes_gcm_enc_kernel_x4_dual_acc_mc /\
  ...
  REWRITE_TAC[ALLPAIRS; PAIRWISE; ALL; fst AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC] THEN
  ...
  REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN CONJ_TAC THENL
   [ENSURES_INIT_TAC "s0" THEN
    MAP_EVERY(fun n -> ARM_STEPS_TAC AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC [n] THEN
  ...
  REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN CONJ_TAC THENL
   [ASM_CASES_TAC `loop_count = 0` THENL
     [POP_ASSUM SUBST_ALL_TAC THEN
      ARM_SIM_TAC AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC [1] THEN
    ...
    ENSURES_WHILE_UP_TAC `loop_count:num` `pc + 0x090` `pc + 0x2e8`
      `\i s.
  ...
  ENSURES_WHILE_UP_TAC `loop_remain:num` `pc + 0x2fc` `pc + 0x3ac`
    `\i s.
  ...
  ASM_REWRITE_TAC[htable_mem_4; GSYM CONJ_ASSOC] THEN REPEAT CONJ_TAC THENL
   [ENSURES_INIT_TAC "s0" THEN
    ...
    ARM_SIM_TAC AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC (1--6) THEN
...
let AES_GCM_ENC_KERNEL_X4_DUAL_ACC_SUBROUTINE_CORRECT = prove
 (`!in_p out_p len_bits tag_p ivec_p key_p htable_p tag0 nonce rk inblock
  ...
  REWRITE_TAC[fst AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC; htable_mem_4] THEN
  CONV_TAC(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV) THEN
  ARM_ADD_RETURN_STACK_TAC
    ~pre_post_nsteps:(11, 11)
    AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC
    (CONV_RULE(ONCE_DEPTH_CONV WORDLIST_FROM_MEMORY_CONV)
       (REWRITE_RULE[fst AES_GCM_ENC_KERNEL_X4_DUAL_ACC_EXEC; htable_mem_4]
          AES_GCM_ENC_KERNEL_X4_DUAL_ACC_CORRECT))
