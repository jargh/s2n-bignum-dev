...
let bignum_demont_p521_mc = define_assert_from_elf "bignum_demont_p521_mc" "arm/p521/bignum_demont_p521.o"
[
  0xa9400c22;       (* arm_LDP X2 X3 X1 (Immediate_Offset (iword (&0))) *)
  0xd377d846;       (* arm_LSL X6 X2 (rvalue (word 9)) *)
  ...
  0x93c5dc45;       (* arm_EXTR X5 X2 X5 (rvalue (word 55)) *)
  ...
  0xaa060042;       (* arm_ORR X2 X2 X6 *)
  0x93c5dc45;       (* arm_EXTR X5 X2 X5 (rvalue (word 55)) *)
  0xa9031404;       (* arm_STP X4 X5 X0 (Immediate_Offset (iword (&48))) *)
  0xd377fc42;       (* arm_LSR X2 X2 (rvalue (word 55)) *)
  0xf9002002;       (* arm_STR X2 X0 (Immediate_Offset (word 64)) *)
  0xd65f03c0        (* arm_RET X30 *)

];;

let BIGNUM_DEMONT_P521_EXEC = ARM_MK_EXEC_RULE bignum_demont_p521_mc;;
...
let BIGNUM_DEMONT_P521_CORRECT = time prove
 (`!z x n pc.
        ...
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) bignum_demont_p521_mc /\
                  read PC s = word pc /\
                  C_ARGUMENTS [z; x] s /\
  ...
  ARM_STEPS_TAC BIGNUM_DEMONT_P521_EXEC (1--21) THEN
 ...
 (`!z x n pc returnaddress.
        ...
        ==> ensures arm
          ...
          (MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bignum(z,9)])`,
  ARM_ADD_RETURN_NOSTACK_TAC BIGNUM_DEMONT_P521_EXEC
...
let full_spec,public_vars = mk_safety_spec
    ...
    BIGNUM_DEMONT_P521_SUBROUTINE_CORRECT
    BIGNUM_DEMONT_P521_EXEC;;

let BIGNUM_DEMONT_P521_SUBROUTINE_SAFE = time prove
 (`exists f_events.
     forall e z x pc returnaddress.
         nonoverlapping (word pc,88) (z,8 * 9) /\
         (x = z \/ nonoverlapping (x,8 * 9) (z,8 * 9))
         ==> ensures arm
             (\s.
                  aligned_bytes_loaded s (word pc) bignum_demont_p521_mc /\
                  read PC s = word pc /\
                  read X30 s = returnaddress /\
                  C_ARGUMENTS [z; x] s /\
                  read events s = e)
