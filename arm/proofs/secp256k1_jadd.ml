...
(**** print_literal_from_elf "arm/secp256k1/secp256k1_jadd.o";;
 ****)
...
[
  ...
  0xa90e53f3;       (* arm_STP X19 X20 SP (Immediate_Offset (iword (&224))) *)
  0xa90f5bf5;       (* arm_STP X21 X22 SP (Immediate_Offset (iword (&240))) *)
  ...
  0xa9442eaa;       (* arm_LDP X10 X11 X21 (Immediate_Offset (iword (&64))) *)
  0xa94536ac;       (* arm_LDP X12 X13 X21 (Immediate_Offset (iword (&80))) *)
  0x9baa7d42;       (* arm_UMULL X2 W10 W10 *)
  0xd360fd4e;       (* arm_LSR X14 X10 32 *)
  0x9bae7dc3;       (* arm_UMULL X3 W14 W14 *)
  0x9bae7d4e;       (* arm_UMULL X14 W10 W14 *)
  ...
  0xa94412a3;       (* arm_LDP X3 X4 X21 (Immediate_Offset (iword (&64))) *)
  ...
  0xa94512a3;       (* arm_LDP X3 X4 X21 (Immediate_Offset (iword (&80))) *)
  ...
  0xa94512a3;       (* arm_LDP X3 X4 X21 (Immediate_Offset (iword (&80))) *)
  0xa94442af;       (* arm_LDP X15 X16 X21 (Immediate_Offset (iword (&64))) *)
  ...
  0xfa100084;       (* arm_SBCS X4 X4 X16 *)
  0xda9f23f0;       (* arm_CSETM X16 Condition_CC *)
  0xa94c03ef;       (* arm_LDP X15 X0 SP (Immediate_Offset (iword (&192))) *)
  0xeb0501e5;       (* arm_SUBS X5 X15 X5 *)
  0xfa060006;       (* arm_SBCS X6 X0 X6 *)
  0xda9f23e0;       (* arm_CSETM X0 Condition_CC *)
  0xca100063;       (* arm_EOR X3 X3 X16 *)
  ...
  0xa94a13e3;       (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&160))) *)
  0xa9441aa5;       (* arm_LDP X5 X6 X21 (Immediate_Offset (iword (&64))) *)
  0x9b057c67;       (* arm_MUL X7 X3 X5 *)
  0x9bc57c68;       (* arm_UMULH X8 X3 X5 *)
  0x9b067c89;       (* arm_MUL X9 X4 X6 *)
  0x9bc67c8a;       (* arm_UMULH X10 X4 X6 *)
  ...
  0x9a10014a;       (* arm_ADC X10 X10 X16 *)
  0xa94b13e3;       (* arm_LDP X3 X4 SP (Immediate_Offset (iword (&176))) *)
  0xa9451aa5;       (* arm_LDP X5 X6 X21 (Immediate_Offset (iword (&80))) *)
  0x9b057c6b;       (* arm_MUL X11 X3 X5 *)
  0x9bc57c6c;       (* arm_UMULH X12 X3 X5 *)
  0x9b067c8d;       (* arm_MUL X13 X4 X6 *)
  0x9bc67c8e;       (* arm_UMULH X14 X4 X6 *)
  ...
  0xfa100084;       (* arm_SBCS X4 X4 X16 *)
  0xda9f23f0;       (* arm_CSETM X16 Condition_CC *)
  0xa94402af;       (* arm_LDP X15 X0 X21 (Immediate_Offset (iword (&64))) *)
  0xeb0501e5;       (* arm_SUBS X5 X15 X5 *)
  0xfa060006;       (* arm_SBCS X6 X0 X6 *)
  0xda9f23e0;       (* arm_CSETM X0 Condition_CC *)
  0xca100063;       (* arm_EOR X3 X3 X16 *)
  ...
  0xa94416a4;       (* arm_LDP X4 X5 X21 (Immediate_Offset (iword (&64))) *)
  0xa9451ea6;       (* arm_LDP X6 X7 X21 (Immediate_Offset (iword (&80))) *)
  ...
  0xa94e53f3;       (* arm_LDP X19 X20 SP (Immediate_Offset (iword (&224))) *)
  0xa94f5bf5;       (* arm_LDP X21 X22 SP (Immediate_Offset (iword (&240))) *)
  0x910403ff;       (* arm_ADD SP SP (rvalue (word 256)) *)
  0xd65f03c0        (* arm_RET X30 *)
];;

let SECP256K1_JADD_EXEC = ARM_MK_EXEC_RULE secp256k1_jadd_mc;;
...
let LOCAL_SQR_P256K1_TAC =
  ARM_MACRO_SIM_ABBREV_TAC secp256k1_jadd_mc 134 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1.
    !n. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = n
    ==>
    aligned 16 (read SP t) /\
    nonoverlapping (word pc,0x2898) (word_add (read p3 t) (word n3),32)
    ==> ensures arm
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [47;48;51;53] (47--53) THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (54--57) (54--57) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (80--90) (80--90) THEN
  RULE_ASSUM_TAC(REWRITE_RULE
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [92;98;100] (91--100) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [101;107;109] (101--109) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [110;111;112;113;115;116;117;118]
    (110--118) THEN
  ...
  ARM_STEPS_TAC SECP256K1_JADD_EXEC [119] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (120--123) (120--123) THEN
...
let LOCAL_MUL_P256K1_TAC =
  ARM_MACRO_SIM_ABBREV_TAC secp256k1_jadd_mc 156 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (69--72) (69--72) THEN
  MAP_EVERY ABBREV_TAC
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [114;120;122] (113--122) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [123; 129; 131] (123--131) THEN
  SUBGOAL_THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC [132;133;134;135;137;138;139;140]
   (132--140) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
  ...
  ARM_STEPS_TAC SECP256K1_JADD_EXEC [141] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (142--145) (142--145) THEN
...
let LOCAL_SUB_P256K1_TAC =
  ARM_MACRO_SIM_ABBREV_TAC secp256k1_jadd_mc 17 lvs
  `!(t:armstate) pcin pcout p3 n3 p1 n1 p2 n2.
    !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
    ==>
    !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (1--8) (1--8) THEN
  ...
  ARM_ACCSTEPS_TAC SECP256K1_JADD_EXEC (12--17) (9--17) THEN
...
let SECP256K1_JADD_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer.
        ...
        ALL (nonoverlapping (stackpointer,224))
            [(word pc,0x2898); (p1,96); (p2,96); (p3,96)] /\
        nonoverlapping (p3,96) (word pc,0x2898)
        ==> ensures arm
             (\s. aligned_bytes_loaded s (word pc) secp256k1_jadd_mc /\
  ...
  LOCAL_SQR_P256K1_TAC 5 ["z1sq";"z_1"] THEN
  ...
  BIGNUM_LDIGITIZE_TAC "x1_"
   `read (memory :> bytes (p1,8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "y1_"
   `read (memory :> bytes (word_add p1 (word 32),8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "z1_"
   `read (memory :> bytes (word_add p1 (word 64),8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "x2_"
   `read (memory :> bytes (p2,8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "y2_"
   `read (memory :> bytes (word_add p2 (word 32),8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "z2_"
   `read (memory :> bytes (word_add p2 (word 64),8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "resx_"
   `read (memory :> bytes (stackpointer,8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "resy_"
   `read (memory :> bytes (word_add stackpointer (word 128),8 * 4)) s28` THEN
  BIGNUM_LDIGITIZE_TAC "resz_"
   `read (memory :> bytes (word_add stackpointer (word 160),8 * 4)) s28` THEN
  ARM_STEPS_TAC SECP256K1_JADD_EXEC (29--87) THEN
  CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN
  ENSURES_FINAL_STATE_TAC THEN ASM_REWRITE_TAC[] THEN
  DISCARD_STATE_TAC "s87" THEN
