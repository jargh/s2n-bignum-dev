...
(* ========================================================================= *)
(* Point addition in Jacobian coordinates for SECG secp256k1 curve.          *)
(* ========================================================================= *)
...
(**** print_literal_from_elf "x86/secp256k1/secp256k1_jadd.o";;
 ****)

let secp256k1_jadd_mc = define_assert_from_elf
  "secp256k1_jadd_mc" "x86/secp256k1/secp256k1_jadd.o"
[
  ...
  0x31; 0xdb;              (* XOR (% ebx) (% ebx) *)
  0xc4; 0xe2; 0xfb; 0xf6; 0x4d; 0x40;
                           (* MULX4 (% rcx,% rax) (% rdx,Memop Quadword (%% (rbp,64))) *)
  0x66; 0x4c; 0x0f; 0x38; 0xf6; 0xd0;
                           (* ADCX (% r10) (% rax) *)
  0xf3; 0x4c; 0x0f; 0x38; 0xf6; 0xd9;
                           (* ADOX (% r11) (% rcx) *)
  0xc4; 0xe2; 0xfb; 0xf6; 0x4d; 0x48;
                           (* MULX4 (% rcx,% rax) (% rdx,Memop Quadword (%% (rbp,72))) *)
  0x66; 0x4c; 0x0f; 0x38; 0xf6; 0xd8;
                           (* ADCX (% r11) (% rax) *)
  0xf3; 0x4c; 0x0f; 0x38; 0xf6; 0xe1;
                           (* ADOX (% r12) (% rcx) *)
...
let secp256k1_jadd_tmc = define_trimmed "secp256k1_jadd_tmc" secp256k1_jadd_mc;;

let SECP256K1_JADD_EXEC = X86_MK_CORE_EXEC_RULE secp256k1_jadd_tmc;;
...
let LOCAL_SQR_P256K1_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE secp256k1_jadd_tmc) 73 lvs
  `!(t:x86state) pcin pcout p3 n3 p1 n1.
    !n. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = n
    ==>
    nonoverlapping (word pc,0x20a8) (word_add (read p3 t) (word n3),32)
    ==> ensures x86
         (\s. bytes_loaded s (word pc) (BUTLAST secp256k1_jadd_tmc) /\
              read RIP s = pcin /\
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC (1--41) (1--41) THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC (42--56) (42--56) THEN
  ABBREV_TAC
  ...
  X86_STEPS_TAC SECP256K1_JADD_EXEC [57] THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC
...
let LOCAL_MUL_P256K1_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE secp256k1_jadd_tmc) 85 lvs
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC (2--56) (2--56) THEN
  MAP_EVERY ABBREV_TAC
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC (57--71) (57--71) THEN
  ABBREV_TAC
  ...
  X86_STEPS_TAC SECP256K1_JADD_EXEC [72] THEN
...
let LOCAL_SUB_P256K1_TAC =
  X86_MACRO_SIM_ABBREV_TAC (X86_TRIM_EXEC_RULE secp256k1_jadd_tmc) 19 lvs
  `!(t:x86state) pcin pcout p3 n3 p1 n1 p2 n2.
    !m. read(memory :> bytes(word_add (read p1 t) (word n1),8 * 4)) t = m
    ==>
    !n. read(memory :> bytes(word_add (read p2 t) (word n2),8 * 4)) t = n
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC [3;5;7;9] (1--9) THEN
  ...
  X86_ACCSTEPS_TAC SECP256K1_JADD_EXEC [12;14;16;18] (10--19) THEN
...
let SECP256K1_JADD_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer.
        ALL (nonoverlapping (stackpointer,224))
            [(word pc,0x20a8); (p1,96); (p2,96); (p3,96)] /\
        nonoverlapping (p3,96) (word pc,0x20a8)
        ==> ensures x86
             (\s. bytes_loaded s (word pc) (BUTLAST secp256k1_jadd_tmc) /\
  ...
  LOCAL_SQR_P256K1_TAC 1 ["z1sq";"z_1"] THEN
  LOCAL_SQR_P256K1_TAC 0 ["z2sq";"z_2"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["y1a";"z_2";"y_1"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["y2a";"z_1";"y_2"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["x2a";"z1sq";"x_2"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["x1a";"z2sq";"x_1"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["y2a";"z1sq";"y2a"] THEN
  LOCAL_MUL_P256K1_TAC 0 ["y1a";"z2sq";"y1a"] THEN
  LOCAL_SUB_P256K1_TAC 0 ["xd";"x2a";"x1a"] THEN
  LOCAL_SUB_P256K1_TAC 0 ["yd";"y2a";"y1a"] THEN
  ...
  X86_STEPS_TAC SECP256K1_JADD_EXEC (25--91) THEN
  ...
  REWRITE_TAC[represents_p256k1; tripled; paired] THEN
  ...
  REWRITE_TAC[GSYM(NUM_REDUCE_CONV `2 EXP 256`)] THENL
   [ONCE_ASM_REWRITE_TAC[] THEN
    ...
    REWRITE_TAC[P256K1_GROUP; weierstrass_add] THEN
    REWRITE_TAC[p_256k1] THEN CONV_TAC INT_REDUCE_CONV;
...
let SECP256K1_JADD_NOIBT_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 272),272))
            [(word pc,LENGTH secp256k1_jadd_tmc); (p1,96); (p2,96)] /\
        ALL (nonoverlapping (p3,96))
            [(word pc,LENGTH secp256k1_jadd_tmc); (word_sub stackpointer (word 272),280)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) secp256k1_jadd_tmc /\
                  read RIP s = word pc /\
                  read RSP s = stackpointer /\
  ...
  X86_PROMOTE_RETURN_STACK_TAC secp256k1_jadd_tmc SECP256K1_JADD_CORRECT
 ...
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ...
        ==> ensures x86
          ...
          (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bytes(p3,96);
                      memory :> bytes(word_sub stackpointer (word 272),272)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SECP256K1_JADD_NOIBT_SUBROUTINE_CORRECT));;

(* ------------------------------------------------------------------------- *)
(* Correctness of Windows ABI version.                                       *)
(* ------------------------------------------------------------------------- *)

let secp256k1_jadd_windows_mc = define_from_elf "secp256k1_jadd_windows_mc"
      "x86/secp256k1/secp256k1_jadd.obj";;

let secp256k1_jadd_windows_tmc = define_trimmed "secp256k1_jadd_windows_tmc" secp256k1_jadd_windows_mc;;

let SECP256K1_JADD_NOIBT_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 288),288))
            [(word pc,LENGTH secp256k1_jadd_windows_tmc); (p1,96); (p2,96)] /\
        ALL (nonoverlapping (p3,96))
            [(word pc,LENGTH secp256k1_jadd_windows_tmc); (word_sub stackpointer (word 288),296)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) secp256k1_jadd_windows_tmc /\
                  read RIP s = word pc /\
                  read RSP s = stackpointer /\
                  read (memory :> bytes64 stackpointer) s = returnaddress /\
  ...
  WINDOWS_X86_WRAP_STACK_TAC
   secp256k1_jadd_windows_tmc secp256k1_jadd_tmc
   SECP256K1_JADD_CORRECT
    `[RBX; RBP; R12; R13; R14; R15]` 272);;

let SECP256K1_JADD_WINDOWS_SUBROUTINE_CORRECT = time prove
 (`!p3 p1 t1 p2 t2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 288),288))
            [(word pc,LENGTH secp256k1_jadd_windows_mc); (p1,96); (p2,96)] /\
        ALL (nonoverlapping (p3,96))
            [(word pc,LENGTH secp256k1_jadd_windows_mc); (word_sub stackpointer (word 288),296)]
        ==> ensures x86
             (\s. bytes_loaded s (word pc) secp256k1_jadd_windows_mc /\
                  read RIP s = word pc /\
                  read RSP s = stackpointer /\
                  read (memory :> bytes64 stackpointer) s = returnaddress /\
                  WINDOWS_C_ARGUMENTS [p3; p1; p2] s /\
          ...
          (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
           MAYCHANGE [memory :> bytes(p3,96);
                      memory :> bytes(word_sub stackpointer (word 288),288)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SECP256K1_JADD_NOIBT_WINDOWS_SUBROUTINE_CORRECT));;
...
let SECP256K1_JADD_SAFE = time prove
 (`exists f_events.
       forall e p3 p1 p2 pc stackpointer.
           ...
           ==> ensures x86
               (\s.
                    bytes_loaded s (word pc) (BUTLAST secp256k1_jadd_tmc) /\
                    read RIP s = word (pc + 0x11) /\
                    read RSP s = stackpointer /\
                    C_ARGUMENTS [p3; p1; p2] s /\
                    read events s = e)
               (\s.
                    read RIP s = word (pc + 0x2096) /\
                    (exists e2.
...
let SECP256K1_JADD_NOIBT_SUBROUTINE_SAFE = time prove
 (`exists f_events.
    forall e p3 p1 p2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 272),272))
        [word pc,LENGTH secp256k1_jadd_tmc; p1,96; p2,96] /\
        ALL (nonoverlapping (p3,96))
        [word pc,LENGTH secp256k1_jadd_tmc;
         word_sub stackpointer (word 272),280]
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) secp256k1_jadd_tmc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 C_ARGUMENTS [p3; p1; p2] s /\
            ...
            (MAYCHANGE [RSP] ,,
             ...
             [memory :> bytes (p3,96);
              memory :> bytes (word_sub stackpointer (word 272),272)])`,
  X86_PROMOTE_RETURN_STACK_TAC secp256k1_jadd_tmc SECP256K1_JADD_SAFE
    `[RBX; RBP; R12; R13; R14; R15]` 272
...
let SECP256K1_JADD_SUBROUTINE_SAFE = time prove
 (`exists f_events.
    forall e p3 p1 p2 pc stackpointer returnaddress.
        ...
        [word pc,LENGTH secp256k1_jadd_mc; p1,96; p2,96] /\
        ALL (nonoverlapping (p3,96))
        [word pc,LENGTH secp256k1_jadd_mc;
         word_sub stackpointer (word 272),280]
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) secp256k1_jadd_mc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 C_ARGUMENTS [p3; p1; p2] s /\
            ...
            (MAYCHANGE [RSP] ,,
             ...
             [memory :> bytes (p3,96);
              memory :> bytes (word_sub stackpointer (word 272),272)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SECP256K1_JADD_NOIBT_SUBROUTINE_SAFE));;

(* ------------------------------------------------------------------------- *)
(* Constant-time and memory safety proof of Windows ABI version.             *)
(* ------------------------------------------------------------------------- *)

let SECP256K1_JADD_NOIBT_WINDOWS_SUBROUTINE_SAFE = time prove
 (`exists f_events.
    forall e p3 p1 p2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 288),288))
        [word pc,LENGTH secp256k1_jadd_windows_tmc; p1,96; p2,96] /\
        ALL (nonoverlapping (p3,96))
        [word pc,LENGTH secp256k1_jadd_windows_tmc;
         word_sub stackpointer (word 288),296]
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) secp256k1_jadd_windows_tmc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 WINDOWS_C_ARGUMENTS [p3; p1; p2] s /\
            ...
            (MAYCHANGE [RSP] ,,
             ...
             [memory :> bytes (p3,96);
              memory :> bytes (word_sub stackpointer (word 288),288)])`,
  WINDOWS_X86_WRAP_STACK_TAC secp256k1_jadd_windows_tmc secp256k1_jadd_tmc
    SECP256K1_JADD_SAFE `[RBX; RBP; R12; R13; R14; R15]` 272
  THEN DISCHARGE_SAFETY_PROPERTY_TAC);;

let SECP256K1_JADD_WINDOWS_SUBROUTINE_SAFE = time prove
 (`exists f_events.
    forall e p3 p1 p2 pc stackpointer returnaddress.
        ALL (nonoverlapping (word_sub stackpointer (word 288),288))
        [word pc,LENGTH secp256k1_jadd_windows_mc; p1,96; p2,96] /\
        ALL (nonoverlapping (p3,96))
        [word pc,LENGTH secp256k1_jadd_windows_mc;
         word_sub stackpointer (word 288),296]
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) secp256k1_jadd_windows_mc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 WINDOWS_C_ARGUMENTS [p3; p1; p2] s /\
            ...
            (MAYCHANGE [RSP] ,,
             ...
             [memory :> bytes (p3,96);
              memory :> bytes (word_sub stackpointer (word 288),288)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE SECP256K1_JADD_NOIBT_WINDOWS_SUBROUTINE_SAFE));;
