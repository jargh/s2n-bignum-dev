...
let SHA3_KECCAK_F1600_SAFE = time prove
 (`exists f_events.
       forall e rc_pointer bitstate_in pc stackpointer.
           nonoverlapping_modulo (2 EXP 64) (pc,1642) (val stackpointer,208) /\
           nonoverlapping_modulo (2 EXP 64) (pc,1642) (val bitstate_in,200) /\
           nonoverlapping_modulo (2 EXP 64) (pc,1642) (val rc_pointer,192) /\
           nonoverlapping_modulo (2 EXP 64) (val bitstate_in,200)
           (val rc_pointer,192) /\
           nonoverlapping_modulo (2 EXP 64) (val bitstate_in,200)
           (val stackpointer,208) /\
           nonoverlapping_modulo (2 EXP 64) (val stackpointer,208)
           (val rc_pointer,192)
           ==> ensures x86
               (\s.
...
exists f_events.
    forall e rc_pointer bitstate_in pc stackpointer returnaddress.
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_tmc)
        (val (word_sub stackpointer (word 256)),256) /\
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_tmc)
        (val bitstate_in,200) /\
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_tmc)
        (val rc_pointer,192) /\
        ...
        (val rc_pointer,192) /\
        nonoverlapping_modulo (2 EXP 64) (val bitstate_in,200)
        (val (word_sub stackpointer (word 256)),264) /\
        ...
        ==> ensures x86
            ...
            (\s.
                 ...
                 (exists e2.
                      ...
                      [bitstate_in,200; word_sub stackpointer (word 256),256]))
            (MAYCHANGE [RSP] ,,
             MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
             MAYCHANGE
             [memory :> bytes (bitstate_in,200);
              memory :> bytes (word_sub stackpointer (word 256),256)])`,
...
exists f_events.
    forall e rc_pointer bitstate_in pc stackpointer returnaddress.
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_mc)
        (val (word_sub stackpointer (word 256)),256) /\
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_mc)
        (val bitstate_in,200) /\
        nonoverlapping_modulo (2 EXP 64) (pc,LENGTH sha3_keccak_f1600_mc)
...
exists f_events.
    forall e rc_pointer bitstate_in pc stackpointer returnaddress.
        nonoverlapping_modulo (2 EXP 64)
        (pc,LENGTH sha3_keccak_f1600_windows_tmc)
        (val (word_sub stackpointer (word 272)),272) /\
        nonoverlapping_modulo (2 EXP 64)
        (pc,LENGTH sha3_keccak_f1600_windows_tmc)
        (val bitstate_in,200) /\
        nonoverlapping_modulo (2 EXP 64)
        ...
        (val rc_pointer,192) /\
        nonoverlapping_modulo (2 EXP 64) (val bitstate_in,200)
        (val (word_sub stackpointer (word 272)),280) /\
        nonoverlapping_modulo (2 EXP 64)
        (val (word_sub stackpointer (word 272)),272)
        (val rc_pointer,192)
        ==> ensures x86
            ...
            (\s.
                 ...
                 (exists e2.
                      ...
                      e2 =
                      f_events rc_pointer bitstate_in pc
                      (word_sub stackpointer (word 272))
                      returnaddress /\
                      memaccess_inbounds e2
                      [bitstate_in,200; rc_pointer,192;
                       word_sub stackpointer (word 272),280]
                      [bitstate_in,200; word_sub stackpointer (word 272),272]))
            (MAYCHANGE [RSP] ,,
             WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
             MAYCHANGE
             [memory :> bytes (bitstate_in,200);
              memory :> bytes (word_sub stackpointer (word 272),272)])`,
  WINDOWS_X86_WRAP_STACK_TAC sha3_keccak_f1600_windows_tmc sha3_keccak_f1600_tmc
    SHA3_KECCAK_F1600_SAFE `[RBX; RBP; R12; R13; R14; R15]` 256 THEN DISCHARGE_SAFETY_PROPERTY_TAC);;
...
exists f_events.
    forall e rc_pointer bitstate_in pc stackpointer returnaddress.
        nonoverlapping_modulo (2 EXP 64)
        (pc,LENGTH sha3_keccak_f1600_windows_mc)
        (val (word_sub stackpointer (word 272)),272) /\
        nonoverlapping_modulo (2 EXP 64)
        (pc,LENGTH sha3_keccak_f1600_windows_mc)
        (val bitstate_in,200) /\
