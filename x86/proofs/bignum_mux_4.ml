 ...
 (`!p z x y m n pc.
     ...
     ==> ensures x86
          ...
          (MAYCHANGE [RIP; RAX; R8] ,, MAYCHANGE SOME_FLAGS ,,
           MAYCHANGE [events] ,, MAYCHANGE [memory :> bignum(z,4)])`,
  MAP_EVERY X_GEN_TAC
    ...
    forall e p z x y pc stackpointer returnaddress.
        ...
        ==> ensures x86
            ...
            (MAYCHANGE [RSP] ,,
             ...
             MAYCHANGE [memory :> bignum (z,4)])`,
  X86_PROMOTE_RETURN_NOSTACK_TAC bignum_mux_4_tmc BIGNUM_MUX_4_SAFE THEN DISCHARGE_SAFETY_PROPERTY_TAC);;
    ...
    forall e p z x y pc stackpointer returnaddress.
        ...
        ==> ensures x86
            ...
            (MAYCHANGE [RSP] ,,
             ...
             [memory :> bignum (z,4);
              memory :> bytes (word_sub stackpointer (word 16),16)])`,
  WINDOWS_X86_WRAP_NOSTACK_TAC bignum_mux_4_windows_tmc bignum_mux_4_tmc BIGNUM_MUX_4_SAFE THEN DISCHARGE_SAFETY_PROPERTY_TAC);;
