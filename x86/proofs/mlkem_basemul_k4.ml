...
print_literal_from_elf "x86/mlkem/mlkem_basemul_k4.o";;

let mlkem_basemul_k4_mc =
  define_assert_from_elf "mlkem_basemul_k4_mc" "x86/mlkem/mlkem_basemul_k4.o"
[
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0x20; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1568))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x00; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,2048))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0x20; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1568))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0x00; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,768))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0x60; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1632))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x40; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1600))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0x60; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1632))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0x20; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,800))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0xa0; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1696))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x80; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1664))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0xa0; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1696))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0x40; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,832))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0xe0; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1760))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0xc0; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1728))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0xe0; 0x06; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1760))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0x60; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,864))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0x20; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1824))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x00; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1792))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0x20; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1824))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0x80; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,896))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0x60; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1888))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x40; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1856))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0x60; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1888))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0xa0; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,928))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0xa0; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,1952))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0x80; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1920))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0xa0; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,1952))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0xc0; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,960))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
  ...
  0xc5; 0xfd; 0x6f; 0x9e; 0xe0; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm3) (Memop Word256 (%% (rsi,2016))) *)
  0xc5; 0xfd; 0x6f; 0xa2; 0xc0; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm4) (Memop Word256 (%% (rdx,1984))) *)
  0xc5; 0xfd; 0x6f; 0xaa; 0xe0; 0x07; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm5) (Memop Word256 (%% (rdx,2016))) *)
  0xc5; 0xfd; 0x6f; 0xb1; 0xe0; 0x03; 0x00; 0x00;
                           (* VMOVDQA (%_% ymm6) (Memop Word256 (%% (rcx,992))) *)
  0xc5; 0x75; 0xd5; 0xea;  (* VPMULLW (%_% ymm13) (%_% ymm1) (%_% ymm2) *)
  0xc5; 0x75; 0xd5; 0xf3;  (* VPMULLW (%_% ymm14) (%_% ymm1) (%_% ymm3) *)
  0xc4; 0xc1; 0x5d; 0xd5; 0xfd;
                           (* VPMULLW (%_% ymm7) (%_% ymm4) (%_% ymm13) *)
...
let pmulacc0_k4 = define
  `pmulacc0_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
               (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
               (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
               (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
              pmul0 a0 b0 c0 dz0 + pmul0 a1 b1 c1 dz1 +
              pmul0 a2 b2 c2 dz2 + pmul0 a3 b3 c3 dz3`;;

let pmulacc0_odd_k4 = define
  `pmulacc0_odd_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
                   (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
                   (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
                   (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
              pmul0_odd a0 b0 c0 dz0 + pmul0_odd a1 b1 c1 dz1 +
              pmul0_odd a2 b2 c2 dz2 + pmul0_odd a3 b3 c3 dz3`;;

let pmulacc1_k4 = define
  `pmulacc1_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
               (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
               (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
               (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
                 pmul1 a0 b0 c0 d0 + pmul1 a1 b1 c1 d1 +
                 pmul1 a2 b2 c2 d2 + pmul1 a3 b3 c3 d3`;;

let pmulaccred0_k4 = define
  `pmulaccred0_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
                  (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
                  (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
                  (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
     (&(inverse_mod 3329 65536) *
        pmulacc0_k4 a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3) rem &3329`;;

let pmulaccred0_odd_k4 = define
  `pmulaccred0_odd_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
                      (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
                      (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
                      (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
     (&(inverse_mod 3329 65536) *
        pmulacc0_odd_k4 a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3) rem &3329`;;


let pmulaccred1_k4 = define
  `pmulaccred1_k4 (a0: int) (b0 : int) (c0 : int) (d0 : int) (dz0 : int)
                  (a1: int) (b1 : int) (c1 : int) (d1 : int) (dz1 : int)
                  (a2: int) (b2 : int) (c2 : int) (d2 : int) (dz2 : int)
                  (a3: int) (b3 : int) (c3 : int) (d3 : int) (dz3 : int) =
     (&(inverse_mod 3329 65536) *
        pmulacc1_k4 a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3) rem &3329`;;

let MLKEM_BASEMUL_K4_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3 pc.
        aligned 32 src1 /\
        aligned 32 src2 /\
        aligned 32 src2t /\
        aligned 32 dst /\
        ...
        ==> ensures x86
              (\s. bytes_loaded s (word pc) (BUTLAST mlkem_basemul_k4_tmc) /\
                   ...
                   (!i. i < 16 ==> !j. j < 8
                        ==> read(memory :> bytes16
                             (word_add src1 (word (1536 + 64*j + 2*i)))) s = a3 i j) /\
                   (!i. i < 16 ==> !j. j < 8
                        ==> read(memory :> bytes16
                             (word_add src1 (word (1536 + 64*j + 32 + 2*i)))) s = b3 i j) /\
                   (!i. i < 16 ==> !j. j < 8
                        ==> read(memory :> bytes16
                             (word_add src2 (word (1536 + 64*j + 2*i)))) s = c3 i j) /\
                   (!i. i < 16 ==> !j. j < 8
                        ==> read(memory :> bytes16
                             (word_add src2 (word (1536 + 64*j + 32 + 2*i)))) s = d3 i j) /\
                   (!i. i < 16 ==> !j. j < 8
                        ==> read(memory :> bytes16
              ...
              (\s. read RIP s = word (pc + 5202) /\
                   (!i. i < 16 ==> !j. j < 4
                        ==> (let j' = 2*j in
                              (abs(ival(a0 i j')) <= &2 pow 12  /\
                               ...
                               abs(ival(a3 i j')) <= &2 pow 12  /\
                               abs(ival(b3 i j')) <= &2 pow 12
                               ==>
                               (ival (read(memory :> bytes16 (word_add dst (word (64*j' + 2*i)))) s)
                                ==
                                pmulaccred0_k4 (ival (a0 i j')) (ival (b0 i j')) (ival (c0 i j')) (ival (d0 i j')) (ival (dz0 i j'))
                                               (ival (a1 i j')) (ival (b1 i j')) (ival (c1 i j')) (ival (d1 i j')) (ival (dz1 i j'))
                                               (ival (a2 i j')) (ival (b2 i j')) (ival (c2 i j')) (ival (d2 i j')) (ival (dz2 i j'))
                                               (ival (a3 i j')) (ival (b3 i j')) (ival (c3 i j')) (ival (d3 i j')) (ival (dz3 i j'))
                               ) (mod &3329)))) /\
                   ...
                   (!i. i < 16 ==> !j. j < 4
                        ==> (let j' = 2*j+1 in
                              (abs(ival(a0 i j')) <= &2 pow 12  /\
                               ...
                               (ival (read(memory :> bytes16 (word_add dst (word (64*j' + 2*i)))) s)
                                ==
                                pmulaccred0_odd_k4 (ival (a0 i j')) (ival (b0 i j')) (ival (c0 i j')) (ival (d0 i j')) (ival (dz0 i j'))
                                                   (ival (a1 i j')) (ival (b1 i j')) (ival (c1 i j')) (ival (d1 i j')) (ival (dz1 i j'))
                                                   (ival (a2 i j')) (ival (b2 i j')) (ival (c2 i j')) (ival (d2 i j')) (ival (dz2 i j'))
                                                   (ival (a3 i j')) (ival (b3 i j')) (ival (c3 i j')) (ival (d3 i j')) (ival (dz3 i j'))
                               ) (mod &3329)))) /\
                   ...
                   (!i. i < 16 ==> !j. j < 8
                        ...
                        ==> (ival (read(memory :> bytes16 (word_add dst (word (64*j + 32 + 2*i)))) s)
                             ==
                             pmulaccred1_k4 (ival (a0 i j)) (ival (b0 i j)) (ival (c0 i j)) (ival (d0 i j)) (ival (dz0 i j))
                                            (ival (a1 i j)) (ival (b1 i j)) (ival (c1 i j)) (ival (d1 i j)) (ival (dz1 i j))
                                            (ival (a2 i j)) (ival (b2 i j)) (ival (c2 i j)) (ival (d2 i j)) (ival (dz2 i j))
                                            (ival (a3 i j)) (ival (b3 i j)) (ival (c3 i j)) (ival (d3 i j)) (ival (dz3 i j))
                            ) (mod &3329)))
  ...
  REWRITE_TAC[pmulaccred0_k4; pmulacc0_k4; pmul0; pmulaccred0_odd_k4;
              pmulacc0_odd_k4; pmul0_odd; pmulaccred1_k4; pmulacc1_k4; pmul1] THEN
  STRIP_TAC THEN
...
let MLKEM_BASEMUL_K4_NOIBT_SUBROUTINE_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3 pc stackpointer returnaddress.
        ...
        ==> ensures x86
              (\s. bytes_loaded s (word pc) mlkem_basemul_k4_tmc /\
                   read RIP s = word pc /\
...
let MLKEM_BASEMUL_K4_SUBROUTINE_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3 pc stackpointer returnaddress.
        ...
        aligned 32 dst /\
        ALL (nonoverlapping (dst, 512)) [(src1, 2048); (src2, 2048); (src2t, 1024)] /\
        nonoverlapping (dst, 512) (word pc, LENGTH mlkem_basemul_k4_mc) /\
        nonoverlapping (dst, 512) (stackpointer, 8)
        ==> ensures x86
              (\s. bytes_loaded s (word pc) mlkem_basemul_k4_mc /\
                   read RIP s = word pc /\
                   read RSP s = stackpointer /\
                   read (memory :> bytes64 stackpointer) s = returnaddress /\
                   C_ARGUMENTS [dst; src1; src2; src2t] s /\
              ...
              (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
               MAYCHANGE [memory :> bytes(dst, 512)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE MLKEM_BASEMUL_K4_NOIBT_SUBROUTINE_CORRECT));;
...
let mlkem_basemul_k4_windows_mc = define_from_elf
    "mlkem_basemul_k4_windows_mc" "x86/mlkem/mlkem_basemul_k4.obj";;

let mlkem_basemul_k4_windows_tmc = define_trimmed
    "mlkem_basemul_k4_windows_tmc" mlkem_basemul_k4_windows_mc;;

let mlkem_basemul_k4_windows_tmc_EXEC = X86_MK_EXEC_RULE mlkem_basemul_k4_windows_tmc;;

let MLKEM_BASEMUL_K4_NOIBT_WINDOWS_SUBROUTINE_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3 pc stackpointer returnaddress.
        aligned 32 src1 /\
        aligned 32 src2 /\
        aligned 32 src2t /\
        aligned 32 dst /\
        nonoverlapping (word pc, LENGTH mlkem_basemul_k4_windows_tmc)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (src1, 2048)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (src2, 2048)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (src2t, 1024)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (dst, 512) (src1, 2048) /\
        nonoverlapping (dst, 512) (src2, 2048) /\
        nonoverlapping (dst, 512) (src2t, 1024) /\
        nonoverlapping (dst, 512) (word pc, LENGTH mlkem_basemul_k4_windows_tmc) /\
        nonoverlapping (dst, 512) (word_sub stackpointer (word 176), 184)
        ==> ensures x86 
              (\s. bytes_loaded s (word pc) mlkem_basemul_k4_windows_tmc /\
                   read RIP s = word pc /\
                   read RSP s = stackpointer /\
                   read (memory :> bytes64 stackpointer) s = returnaddress /\
              ...
              (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
               ...
               MAYCHANGE [memory :> bytes(dst, 512)])`,
  REPLICATE_TAC 25 GEN_TAC THEN
  WORD_FORALL_OFFSET_TAC 176 THEN
  REPEAT GEN_TAC THEN

  REWRITE_TAC[fst mlkem_basemul_k4_windows_tmc_EXEC] THEN
  ...
  ENSURES_INIT_TAC "s0" THEN
  X86_STEPS_TAC mlkem_basemul_k4_windows_tmc_EXEC (1--18) THEN
  ...
  MP_TAC(SPECL [`src1:int64`; `src2:int64`; `src2t:int64`; `dst:int64`;
                ...
                `a2:num->num->int16`; `b2:num->num->int16`; `c2:num->num->int16`; `d2:num->num->int16`; `dz2:num->num->int16`;
                `a3:num->num->int16`; `b3:num->num->int16`; `c3:num->num->int16`; `d3:num->num->int16`; `dz3:num->num->int16`;
                `pc + 105`] MLKEM_BASEMUL_K4_CORRECT) THEN
  ASM_REWRITE_TAC[C_ARGUMENTS; SOME_FLAGS] THEN REWRITE_TAC[ALL] THEN
  ANTS_TAC THENL [NONOVERLAPPING_TAC; ALL_TAC] THEN

  X86_BIGSTEP_TAC mlkem_basemul_k4_windows_tmc_EXEC "s19" THENL
   [FIRST_ASSUM(MATCH_ACCEPT_TAC o MATCH_MP
     (BYTES_LOADED_SUBPROGRAM_RULE mlkem_basemul_k4_windows_tmc
     (REWRITE_RULE[BUTLAST_CLAUSES]
      (AP_TERM `BUTLAST:byte list->byte list` mlkem_basemul_k4_tmc))
     105));
  ...
  X86_STEPS_TAC mlkem_basemul_k4_windows_tmc_EXEC (20--34) THEN
...
let MLKEM_BASEMUL_K4_WINDOWS_SUBROUTINE_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 a3 b3 c3 d3 dz3 pc stackpointer returnaddress.
        aligned 32 src1 /\
        aligned 32 src2 /\
        aligned 32 src2t /\
        aligned 32 dst /\
        nonoverlapping (word pc, LENGTH mlkem_basemul_k4_windows_mc)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (src1, 2048)
                       (word_sub stackpointer (word 176), 176) /\
        nonoverlapping (src2, 2048)
        ...
        nonoverlapping (dst, 512) (src2, 2048) /\
        nonoverlapping (dst, 512) (src2t, 1024) /\
        nonoverlapping (dst, 512) (word pc, LENGTH mlkem_basemul_k4_windows_mc) /\
        nonoverlapping (dst, 512) (word_sub stackpointer (word 176), 184)
        ==> ensures x86 
              (\s. bytes_loaded s (word pc) mlkem_basemul_k4_windows_mc /\
                   read RIP s = word pc /\
                   read RSP s = stackpointer /\
                   read (memory :> bytes64 stackpointer) s = returnaddress /\
                   WINDOWS_C_ARGUMENTS [dst; src1; src2; src2t] s /\
              ...
              (MAYCHANGE [RSP] ,, WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
               MAYCHANGE [memory :> bytes(word_sub stackpointer (word 176), 176)] ,,
               MAYCHANGE [memory :> bytes(dst, 512)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE MLKEM_BASEMUL_K4_NOIBT_WINDOWS_SUBROUTINE_CORRECT));;
...
let full_spec,public_vars = mk_safety_spec
    ...
    MLKEM_BASEMUL_K4_CORRECT
    mlkem_basemul_k4_tmc_EXEC;;

let MLKEM_BASEMUL_K4_SAFE = time prove
 (`exists f_events.
       forall e src1 src2 src2t dst pc.
           ...
           ==> ensures x86
               (\s.
                    bytes_loaded s (word pc) (BUTLAST mlkem_basemul_k4_tmc) /\
                    read RIP s = word pc /\
                    C_ARGUMENTS [dst; src1; src2; src2t] s /\
                    read events s = e)
               (\s.
...
let MLKEM_BASEMUL_K4_NOIBT_SUBROUTINE_SAFE = time prove
 (`
exists f_events.
    forall e src1 src2 src2t dst pc stackpointer returnaddress.
        ...
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) mlkem_basemul_k4_tmc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 C_ARGUMENTS [dst; src1; src2; src2t] s /\
            ...
            (\s.
                 ...
                 (exists e2.
                      read events s = APPEND e2 e /\
                      e2 =
                      f_events src1 src2 src2t dst pc stackpointer
                      returnaddress /\
                      memaccess_inbounds e2
                      [src1,2048; src2,2048; src2t,1024; dst,512;
                       stackpointer,8]
                      [dst,512; stackpointer,0]))
            (MAYCHANGE [RSP] ,,
             MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
             MAYCHANGE [memory :> bytes (dst,512)])`,
  X86_PROMOTE_RETURN_NOSTACK_TAC mlkem_basemul_k4_tmc MLKEM_BASEMUL_K4_SAFE
...
exists f_events.
    forall e src1 src2 src2t dst pc stackpointer returnaddress.
        ...
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) mlkem_basemul_k4_mc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 C_ARGUMENTS [dst; src1; src2; src2t] s /\
            ...
            (MAYCHANGE [RSP] ,,
             MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
             MAYCHANGE [memory :> bytes (dst,512)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE MLKEM_BASEMUL_K4_NOIBT_SUBROUTINE_SAFE));;

(* ------------------------------------------------------------------------- *)
(* Constant-time and memory safety proof of Windows ABI version.             *)
(* ------------------------------------------------------------------------- *)

let MLKEM_BASEMUL_K4_NOIBT_WINDOWS_SUBROUTINE_SAFE = time prove
 (`
exists f_events.
    forall e src1 src2 src2t dst pc stackpointer returnaddress.
        aligned 32 src1 /\
        ...
        nonoverlapping (word pc,LENGTH mlkem_basemul_k4_windows_tmc)
        (word_sub stackpointer (word 176),176) /\
        nonoverlapping (src1,2048) (word_sub stackpointer (word 176),176) /\
        nonoverlapping (src2,2048) (word_sub stackpointer (word 176),176) /\
        nonoverlapping (src2t,1024) (word_sub stackpointer (word 176),176) /\
        nonoverlapping (dst,512) (src1,2048) /\
        nonoverlapping (dst,512) (src2,2048) /\
        nonoverlapping (dst,512) (src2t,1024) /\
        nonoverlapping (dst,512)
        (word pc,LENGTH mlkem_basemul_k4_windows_tmc) /\
        nonoverlapping (dst,512) (word_sub stackpointer (word 176),184)
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) mlkem_basemul_k4_windows_tmc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 WINDOWS_C_ARGUMENTS [dst; src1; src2; src2t] s /\
            ...
            (\s.
                 ...
                 (exists e2.
                      read events s = APPEND e2 e /\
                      e2 =
                      f_events src1 src2 src2t dst pc
                      (word_sub stackpointer (word 176))
                      returnaddress /\
                      memaccess_inbounds e2
                      [src1,2048; src2,2048; src2t,1024; dst,512;
                       word_sub stackpointer (word 176),184]
                      [dst,512; word_sub stackpointer (word 176),176]))
            (MAYCHANGE [RSP] ,,
             WINDOWS_MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
             MAYCHANGE
             [memory :> bytes (word_sub stackpointer (word 176),176)] ,,
             MAYCHANGE [memory :> bytes (dst,512)])`,
  ASSUME_CALLEE_SAFETY_TAC MLKEM_BASEMUL_K4_SAFE "H_subth" THEN
  ...
  W(fun (asl,w) ->
    ...
    then failwith "More than 'read events .. = ..?'"
      ...
      REMOVE_THEN "H_subth"
        (MP_TAC o SPECL [hd current_events; `src1:int64`; `src2:int64`; `src2t:int64`; `dst:int64`; `pc + 105`]))
  THEN
...
let MLKEM_BASEMUL_K4_WINDOWS_SUBROUTINE_SAFE = time prove
 (`
exists f_events.
    forall e src1 src2 src2t dst pc stackpointer returnaddress.
        aligned 32 src1 /\
        ...
        ==> ensures x86
            (\s.
                 bytes_loaded s (word pc) mlkem_basemul_k4_windows_mc /\
                 read RIP s = word pc /\
                 read RSP s = stackpointer /\
                 read (memory :> bytes64 stackpointer) s = returnaddress /\
                 WINDOWS_C_ARGUMENTS [dst; src1; src2; src2t] s /\
